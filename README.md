...
![NPM version](https://img.shields.io/npm/v/@yixuan-liu-afe/react-sortable-tree.svg?style=flat)
![NPM license](https://img.shields.io/npm/l/@yixuan-liu-afe/react-sortable-tree.svg?style=flat)
[![NPM total downloads](https://img.shields.io/npm/dt/@yixuan-liu-afe/react-sortable-tree.svg?style=flat)](https://npmcharts.com/compare/@yixuan-liu-afe/react-sortable-tree?minimal=true)
[![NPM monthly downloads](https://img.shields.io/npm/dm/@yixuan-liu-afe/react-sortable-tree.svg?style=flat)](https://npmcharts.com/compare/@yixuan-liu-afe/react-sortable-tree?minimal=true)
...
```sh
# NPM
npm install @yixuan-liu-afe/react-sortable-tree --save

# YARN
yarn add @yixuan-liu-afe/react-sortable-tree
```
...
import '@yixuan-liu-afe/react-sortable-tree/style.css';

// You can import the default tree with dnd context
import SortableTree from '@yixuan-liu-afe/react-sortable-tree';

// Or you can import the tree without the dnd context as a named export. eg
import { SortableTreeWithoutDndContext as SortableTree } from '@yixuan-liu-afe/react-sortable-tree';

// Importing from cjs (default)
import SortableTree from '@yixuan-liu-afe/react-sortable-tree/dist/index.cjs.js';
import SortableTree from '@yixuan-liu-afe/react-sortable-tree';

// Importing from esm
import SortableTree from '@yixuan-liu-afe/react-sortable-tree/dist/index.esm.js';
```
...
import SortableTree from '@yixuan-liu-afe/react-sortable-tree';
import '@yixuan-liu-afe/react-sortable-tree/style.css'; // This only needs to be imported once in your app
